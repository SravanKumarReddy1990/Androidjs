    ...
    function buildRMessage(text) {
        modal.style.display = "none";
        var element = document.createElement('div');
        element.classList.add('message', 'received');

        element.innerHTML = text + '<span class="metadata"><span class="time"></span></span>\n';
